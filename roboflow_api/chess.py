...
model.predict("/Users/akash/Source/chessAI/Chessboard_Recognition/images/Chessboard2.jpg").save("/Users/akash/Source/chessAI/Chessboard_Recognition/roboflow_api/results/prediction.jpg")
...
if len(pts) >= 0:
    ...
    cv2.imwrite("results/cropped.png", cropped)
else:
